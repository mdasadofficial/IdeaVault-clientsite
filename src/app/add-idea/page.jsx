...
import { FieldError, Input, Label, TextArea, TextField, Select, ListBox, Button } from '@heroui/react';
...
const AddIdeaPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    startTransition(async () => {
      // এখানে আপনার ব্যাকএন্ড API কল হবে (যেমন: axios.post বা fetch)
      // সফল হলে রিকোয়ারমেন্ট অনুযায়ী Toast মেসেজ দেখাবেন
    });
  };
  ...
  return (
    <div className="max-w-4xl mx-auto my-10 bg-white dark:bg-gray-900 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-700 p-8 text-white text-center md:text-left">
        <h1 className="text-2xl md:text-3xl font-black">Share Your Innovation</h1>
        <p className="text-indigo-100 text-sm mt-1">Submit your startup concept to get validated by a global community of builders.</p>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          <div className="md:col-span-2">
            <TextField name="ideaTitle" isRequired>
              <Label className="text-sm font-semibold text-gray-700 dark:text-gray-300">Idea Title</Label>
              <Input placeholder="e.g., EcoDrop: Smart Water Management" className="rounded-2xl mt-1.5" />
            ...
            >
              ...
              <Select.Popover>
                <ListBox>
                  ...
                  <ListBox.Item id="AI" textValue="AI">Artificial Intelligence <ListBox.ItemIndicator /></ListBox.Item>
                  <ListBox.Item id="Health" textValue="Health">Health-Tech <ListBox.ItemIndicator /></ListBox.Item>
                  <ListBox.Item id="Education" textValue="Education">EdTech <ListBox.ItemIndicator /></ListBox.Item>
                  <ListBox.Item id="Finance" textValue="Finance">FinTech <ListBox.ItemIndicator /></ListBox.Item>
                </ListBox>
              </Select.Popover>
            </Select>
          </div>
          ...
          <TextField name="estimatedBudget" type="text">
            <Label className="text-sm font-semibold text-gray-700 dark:text-gray-300">Estimated Budget (Optional)</Label>
          ...
          <div className="md:col-span-2">
            <TextField name="imageUrl" isRequired>
              <Label className="text-sm font-semibold text-gray-700 dark:text-gray-300">Concept Banner Image URL</Label>
              <Input type="url" placeholder="https://images.unsplash.com/.../mockup.jpg" className="rounded-2xl mt-1.5" />
              <FieldError className="text-xs text-red-500 mt-1" />
            </TextField>
          </div>
          ...
          <div className="md:col-span-2">
            <TextField name="tags">
              ...
              <Input placeholder="e.g., iot, green-energy, saas (comma separated)" className="rounded-2xl mt-1.5" />
              <FieldError className="text-xs text-red-500 mt-1" />
            </TextField>
          </div>
          ...
          <div className="md:col-span-2">
            <TextField name="targetAudience" isRequired>
              ...
              <Input placeholder="e.g., Urban Homeowners, Property Managers" className="rounded-2xl mt-1.5" />
              <FieldError className="text-xs text-red-500 mt-1" />
            </TextField>
          </div>
          ...
          <div className="md:col-span-2">
            <TextField name="shortDescription" isRequired>
              ...
              <Input placeholder="Give a brief 1-line elevator pitch..." className="rounded-2xl mt-1.5" />
              <FieldError className="text-xs text-red-500 mt-1" />
            </TextField>
          </div>
          ...
          <div className="md:col-span-2">
            <TextField name="proposedSolution" isRequired>
              <Label className="text-sm font-semibold text-gray-700 dark:text-gray-300">Proposed Solution</Label>
              <TextArea
