...
export default function Footer() {
  return (
    <footer className="bg-gray-50 dark:bg-gray-950 border-t border-gray-200 dark:border-gray-800 transition-colors duration-300 w-full">
      <div className="container mx-auto px-4 sm:px-6 md:px-8 py-10 md:py-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="space-y-4 text-center sm:text-left">
            <Link href="/" className="text-2xl font-black tracking-tight text-indigo-600 dark:text-indigo-400">
              IdeaVault<span className="text-gray-900 dark:text-white">.</span>
            </Link>
            <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed max-w-sm mx-auto sm:mx-0">
              A secure community platform built for entrepreneurs and developers to share, validate, and scale innovative startup concepts together.
            </p>
          </div>
          ...
          <div className="space-y-3 text-center sm:text-left">
            ...
            <ul className="space-y-2 text-sm font-medium text-gray-600 dark:text-gray-400">
              ...
              <li>
                <Link href="/add-idea" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  Submit an Idea
                </Link>
              </li>
              <li>
                <Link href="/my-ideas" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  My Dashboard
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-3 text-center sm:text-left">
            ...
            <ul className="space-y-2 text-sm font-medium text-gray-600 dark:text-gray-400">
              ...
              <li>
                <Link href="/ideas?category=Health" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  Health & Medical
                </Link>
              </li>
              <li>
                <Link href="/ideas?category=Education" className="hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors">
                  EdTech Solutions
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-3 text-center sm:text-left">
            ...
            <ul className="space-y-2.5 text-sm font-medium text-gray-600 dark:text-gray-400 flex flex-col items-center sm:items-start">
              ...
              <li className="flex items-center gap-2.5">
                <span className="text-base">✉️</span> mdasadofficial1@gamil.com
              </li>
              <li className="flex items-center gap-2.5">
        ...
        <div className="pt-6 border-t border-gray-200 dark:border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 font-medium order-2 sm:order-1">
            © {new Date().getFullYear()} IdeaVault Platform. All rights reserved.
          </p>
