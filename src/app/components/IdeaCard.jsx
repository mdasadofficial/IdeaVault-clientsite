...
const IdeaCard = ({ idea }) => {
  ...
  const defaultImage = "https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=600&auto=format&fit=crop";
  ...
  return (
    <div className=" max-w-sm rounded-2xl overflow-hidden shadow-lg bg-white border border-gray-100 hover:shadow-2xl transition-all duration-300 ease-in-out flex flex-col justify-between group h-full">
      ...
      <div className="p-5 flex-1 flex flex-col justify-between">
        {/* Title */}
        <div className="mb-4">
          <h3 className="font-bold text-lg md:text-xl text-gray-800 leading-snug line-clamp-2 group-hover:text-blue-600 transition-colors duration-200" title={ideaTitle}>
            {ideaTitle}
          </h3>
        </div>
